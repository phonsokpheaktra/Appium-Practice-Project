...
# Download a class photo

class TestDownloadClassPhoto(unittest.TestCase):
    ...
    def test_download_class_photo(self):
        ...
        StudentPhotoThumbnailPage(self.driver).tap_class_photo().tap_top_left_photo_thumbnail().tap_download_photo().back_to_previous_page()
